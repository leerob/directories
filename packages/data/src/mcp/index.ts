...
export default [
  ...
  {
    name: "WhichModel",
    url: "https://github.com/Which-Model/whichmodel-mcp",
    endpoint: "https://whichmodel.dev/mcp",
    description:
      "Cost-optimized LLM model routing for AI agents — real-time pricing and benchmarks across 300+ models.",
    logo: "https://whichmodel.dev/logo.png",
  },
];
