export const shopifyAppExtensionTypescriptConversion = [
  {
    title: "Shopify App Extension Typescript Conversion",
    tags: ["Shopify", "App Extension", "Typescript Conversion", "Best Practices", "Preact", "Polaris", "Web Components", "TypeScript"],
    slug: "shopify-app-extension-typescript-conversion",
    libs: ["Preact", "Polaris", "Web Components", "TypeScript"],
    content: `
# Converting Shopify App Extensions from JavaScript to TypeScript

## Overview

Shopify App Extensions can be written in TypeScript (\`.tsx\`) instead of JavaScript (\`.jsx\`). This provides better type safety and IDE support.
...
declare module './src/Checkout.tsx' {  // Changed from .jsx
